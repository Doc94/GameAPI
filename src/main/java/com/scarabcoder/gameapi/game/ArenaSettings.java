...
public class ArenaSettings {
	...
	private boolean allowDropOnPlayerDie;
	...
	public boolean isAllowDropOnPlayerDie() {
		return this.allowDropOnPlayerDie;
	}

	public void setAllowDropOnPlayerDie(boolean allowDropOnPlayerDie) {
		this.allowDropOnPlayerDie = allowDropOnPlayerDie;
	}
